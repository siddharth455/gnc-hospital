...
<section class="page-title  page-title-layout7 bg-overlay pb-0">
  <div class="bg-img"><img src="assets/uploads/orthopedic-3.webp" alt="background"></div>
  <div class="container">
    <div class="row">
        ...
        <div class="info-card">
          <div class="row">
            <div class="col-sm-12 col-md-5">
              <img src="assets/uploads/orthopedic-2.webp" alt="banner" class="rounded mb-20">
            </div><!-- /.col-md-5 -->
...
<section class="pt-120 pb-80">
  ...
  <img src="assets/uploads/orthopedic-1.webp" alt="banner" style="height:100%; width:100%; object-fit:cover;">
</div>
<!-- /.video-banner -->
