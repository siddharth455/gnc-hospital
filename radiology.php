...
<section class="page-title  page-title-layout7 bg-overlay pb-0">
  <div class="bg-img"><img src="assets/uploads/radiology-3.webp" alt="background"></div>
  <div class="container">
    <div class="row">
        ...
        <div class="info-card">
          <div class="row">
            <div class="col-sm-12 col-md-5">
              <img src="assets/uploads/radiology-2.webp" alt="banner" class="rounded mb-20">
            </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-12 col-lg-8">
        ...
        <div class="video-banner-layout2 mb-70" style="height:320px; overflow:hidden; border-radius:8px;">
          <img src="assets/uploads/radiology-1.webp" alt="banner" style="height:100%; width:100%; object-fit:cover;">
        </div>
